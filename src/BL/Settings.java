...
@NamedQueries({
    ...
    , @NamedQuery(name = "Settings.findByValidation", query = "SELECT s FROM Settings s WHERE s.validation = :validation")})
public class Settings implements Serializable {
    ...
    public Settings(Integer id, String name, String value, String description, String validation) {
        this.id = id;
        this.name = name;
        this.value = value;
